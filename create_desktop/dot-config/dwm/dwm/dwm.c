...
static int dwmlogowdth = 63; /* dwm logo width */
...
drawbar(Monitor *m)
{
	...
	const DwmLogo dwmLogo[] = {
		{  5,  9, stroke, letterHeight / 2 }, /* d: left vertical */
		{  5, 17,     35, stroke           }, /* d: bottom horizontal */
		{ 18, -4, stroke, letterHeight     }, /* d: right vertical */
		{  5,  9,     15, stroke           }, /* d: top horizontal */
		{ 27,  9, stroke, letterHeight / 2 }, /* w: center vertical */
		{ 36,  9, stroke, letterHeight / 2 }, /* w: right vertical */
		{ 36,  9,     22, stroke           }, /* m: top horizontal */
		{ 45, 10, stroke, letterHeight / 2 }, /* m: center vertical */
		{ 54, 10, stroke, letterHeight / 2 }  /* m: right vertical */
	};
